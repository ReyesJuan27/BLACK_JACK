( () => {
    ...
    const btnNewGame = document.querySelector('#btnNewGame'),
          ...
          imageContainerPlayer = document.querySelector('.imagesCardsPlayer'),
          imageContainerPc = document.querySelector('.imagesCardsPc'),
          scoreBarPlayer = document.querySelector('#scoreBarPlayer'),
          scoreBarPc = document.querySelector('#scoreBarPc');
    ...
    let sumPlayer = 0, sumPc = 0, theTruthPlayer, theTruthPc;
    ...
    const randomLetterCard = ()=> {
        ...
        return possibleLetters[ramdomIndex];
    }
